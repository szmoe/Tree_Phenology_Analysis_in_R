...
grid.text("Temperature response pattern of‘Alexander\nLucas' pears in Klein-Altendorf,as determined\nby PLS regression and plotted with the\nstandard function in chillR", 
          x = 0.88, y = 0.15, gp = gpar(fontsize = 10, fontface = "italic"))
...
trying to relate high-resolution temperature to tree phenology. We have one dependent variable, just a few observations and lots of independent variables.
